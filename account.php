...
<html lang="en">
 ...
 <!-- SCROLL TOP BUTTON -->
  ...
  <section id="aa-catg-head-banner">
    <img src="img/fashion/header2.jpg" alt="fashion img">
        ...
        <div class="aa-myaccount-area">         
            <div class="row">
              <div class="col-md-6">
                ...
                <h4>Login</h4>
                 <form action="login_php.php" method="post" class="aa-login-form">
              ...
              <div class="col-md-6">
                <div class="aa-myaccount-register">                 
                 ...
                 <form action="" method="post"  class="aa-login-form">
                    ...
                    <input type="text" placeholder="Number" name="pnumber">
                    <button type="submit" name="submit" class="aa-browse-btn">Register me</button>                    
                  </form>
                </div>
              </div>
            </div>          
 ...
 <?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      $pro = "SELECT * FROM user_detail ";
      $pro_check = mysqli_query($mysqli,$pro);
      $count1 = mysqli_num_rows($pro_check);
      $count1 += 1;
      $product = $count1;

      $result= "INSERT into user_detail values('$product','$user_email','$user_name','$user_password','$user_pnumber')";
      $result_run = mysqli_query($mysqli,$result);

      if($result_run)
      {
        echo'<script>alert("Succcessfully Created.")</script>';
      }
      else{
